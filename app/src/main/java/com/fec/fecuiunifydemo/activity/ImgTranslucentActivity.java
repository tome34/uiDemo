...
import com.fec.view.common.topbar.ImgTopBarLayout;
...
public class ImgTranslucentActivity extends AppCompatActivity {

    @BindView(R.id.topbar)
    ImgTopBarLayout mTopBar;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        StatusBarHelper.translucent(this); // 沉浸式状态栏
        View root = LayoutInflater.from(this).inflate(R.layout.activity_translucent_img, null);
