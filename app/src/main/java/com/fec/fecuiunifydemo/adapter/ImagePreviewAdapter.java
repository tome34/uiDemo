...
import com.fec.fecuiunifydemo.activity.PhotoViewActivity;
...
public class ImagePreviewAdapter extends PagerAdapter implements PhotoViewAttacher.OnPhotoTapListener {
    ...
    private ArrayList<String> mPreviewBeans;
    private Context mContext ;
    public ImagePreviewAdapter(Context context, @NonNull ArrayList<String> photoList) {
        super();
    ...
    public Object instantiateItem(@NonNull ViewGroup container, int position) {
        ...
        String imageStr = this.mPreviewBeans.get(position);
        ...
        Glide.with(mContext).load(imageStr).apply(options).into(imageView);
