...
import com.fec.fecuiunifydemo.utils.ImageLoadUtils;
        ...
        switch (type) {
            case VIEW_TYPE_LEFT_TEXT:
                ...
                if (convertView == null) {
                    ...
                    holderView = mInflater.inflate(R.layout.listitem_cha_left_text1,null);
                    holderView.setFocusable(true);
                    holder.iv_avatar = holderView.findViewById(R.id.iv_avatar);
                    holder.tv_content = holderView.findViewById(R.id.tv_content);
