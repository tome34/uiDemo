...
import com.fec.view.common.layout.ILayout;
import com.fec.view.common.layout.QFrameLayout;
 ...
 */
public class PopupView extends BasePopup {
    ...
    public PopupView(Context context, @Direction int preferredDirection) {
        super(context);
    ...
    private void setAnimationStyle(int screenWidth, int requestedX) {
        ...
        switch (mAnimStyle) {
            case ANIM_GROW_FROM_LEFT:
                mWindow.setAnimationStyle(onTop ? R.style.Animation_PopUpMenu_Left : R.style.Animation_PopDownMenu_Left);
                break;

            case ANIM_GROW_FROM_RIGHT:
                mWindow.setAnimationStyle(onTop ? R.style.Animation_PopUpMenu_Right : R.style.Animation_PopDownMenu_Right);
                break;

            case ANIM_GROW_FROM_CENTER:
                mWindow.setAnimationStyle(onTop ? R.style.Animation_PopUpMenu_Center : R.style.Animation_PopDownMenu_Center);
                break;
            case ANIM_AUTO:
    ...
    public void setContentView(View root) {
        if (root.getBackground() != null) {
            if (root instanceof ILayout) {
                ((ILayout) root).setRadius(getRootLayoutRadius(mContext));
            } else {
                QFrameLayout clipLayout = new QFrameLayout(mContext);
    ...
    /**
     * the root layout: must provide ids: arrow_down(ImageView), arrow_up(ImageView), box(QFrameLayout)
     *
     * @return
     */
    @LayoutRes
    ...
    protected int getRootLayoutRadius(Context context) {
        return DisplayHelper.dp2px(context, 5);
    }
    ...
    public ViewGroup.LayoutParams generateLayoutParam(int width, int height) {
        return new QFrameLayout.LayoutParams(width, height);
    }
