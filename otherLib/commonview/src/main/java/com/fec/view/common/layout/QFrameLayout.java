...
import com.fec.view.common.utils.QLayoutHelper;
...
public class QFrameLayout extends AlphaFrameLayout implements ILayout {
    private QLayoutHelper mLayoutHelper;
    ...
    public QFrameLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs, 0);
    }

    public QFrameLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init(context, attrs, defStyleAttr);
    }

    private void init(Context context, AttributeSet attrs, int defStyleAttr) {
        mLayoutHelper = new QLayoutHelper(context, attrs, 0, this);
    ...
    public void setRadiusAndShadow(int topRadius, @QLayoutHelper.HideRadiusSide int hideRadiusSide, int shadowElevation, final float shadowAlpha) {
    ...
    public void setRadius(int radius, @QLayoutHelper.HideRadiusSide int hideRadiusSide) {
