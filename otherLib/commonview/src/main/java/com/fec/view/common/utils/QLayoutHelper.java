package com.fec.view.common.utils;
...
public class QLayoutHelper implements ILayout {
    ...
    public QLayoutHelper(Context context, AttributeSet attrs, int defAttr, View owner) {
        mContext = context;
        ...
        mShadowAlpha = ResHelper.getAttrFloatValue(context, R.attr.qmui_general_shadow_alpha);
        ...
        if (shadow == 0 && useThemeGeneralShadowElevation) {
            shadow = ResHelper.getAttrDimen(context, R.attr.qmui_general_shadow_elevation);
    ...
    public void setUseThemeGeneralShadowElevation() {
        mShadowElevation = ResHelper.getAttrDimen(mContext, R.attr.qmui_general_shadow_elevation);
