package com.fec.view.common.tab;
...
import com.fec.view.common.utils.ColorHelper;
...
public class TabSegment extends HorizontalScrollView {
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mDefaultSelectedColor = ResHelper.getAttrColor(context, R.attr.colorAccent);
        mDefaultNormalColor = ContextCompat.getColor(context, R.color.colorPrimary);
        ...
        mIndicatorHeight = array.getDimensionPixelSize(R.styleable.TabSegment_tab_indicator_height,DisplayHelper.dp2px(context,1));
        mTabTextSize = array.getDimensionPixelSize(R.styleable.TabSegment_android_textSize,DisplayHelper.sp2px(context,13));
...
//            viewPager.addOnAdapterChangeListener(mAdapterChangeListener);
        ...
        animator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            ...
            public void onAnimationUpdate(ValueAnimator animation) {
                ...
                if (mIndicatorView != null && listViews.size() > 1) {
                    ...
                    if (mIndicatorDrawable == null) {
                        mIndicatorView.setBackgroundColor(ColorHelper.computeColor(getTabSelectedColor(prevModel), getTabSelectedColor(nowModel), animValue));
                    }
    ...
    public void updateIndicatorPosition(final int index, float offsetPercent) {
        ...
        if (mIndicatorView != null && listViews.size() > 1) {
            ...
            if (mIndicatorDrawable == null) {
                int indicatorColor = ColorHelper.computeColor(getTabSelectedColor(preModel), getTabSelectedColor(targetModel), offsetPercent);
    ...
    public static class Tab {
        ...
        public int getSignCount() {
            ...
            if (!LangHelper.isNullOrEmpty(mSignCountTextView.getText())) {
