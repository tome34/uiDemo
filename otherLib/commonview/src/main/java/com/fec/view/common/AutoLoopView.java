...
public class AutoLoopView<ITEM> extends RelativeLayout implements LifecycleObserver {
    ...
    public AutoLoopView(Context context, AttributeSet attrs) {
        ...
        inflater.inflate(R.layout.view_auto_poll_image, this, true);
        vp = (ViewPager) findViewById(R.id.vp);
        dot_layout = (LinearLayout) findViewById(R.id.ll_dot_layout);
        TypedArray attributes = context.obtainStyledAttributes(attrs, R.styleable.AutoLoopView);
        dotSize = attributes.getDimensionPixelSize(R.styleable.AutoLoopView_dot_size, 5);
        autoChangeDuration = attributes.getInt(R.styleable.AutoLoopView_autoChangeDuration, autoChangeDuration);
        changeDuration = attributes.getInteger(R.styleable.AutoLoopView_changeDuration, changeDuration);
        selectDotRes = attributes.getResourceId(R.styleable.AutoLoopView_selectedDotRes, R.mipmap.dian_blue);
        noSelectDotRes = attributes.getResourceId(R.styleable.AutoLoopView_noSelectedDotRes, R.mipmap.dian_grey);
        int dotLayoutGravity = attributes.getInteger(R.styleable.AutoLoopView_dotLayoutGravity, 1);
