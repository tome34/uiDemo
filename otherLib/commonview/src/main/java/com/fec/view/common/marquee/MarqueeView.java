package com.fec.view.common.marquee;
...
import com.fec.view.common.marquee.listener.AnimationListenerAdapter;
    ...
    private final OnClickListener onClickListener = new OnClickListener() {
        ...
        public void onClick(View v) {
            if (onItemClickListener != null) {
                if (factory == null || isEmpty(factory.getData()) || getChildCount() == 0) {
